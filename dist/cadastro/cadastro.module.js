...
const cadastro_controller_1 = require("./cadastro.controller");
...
exports.CadastroModule = CadastroModule = __decorate([
    (0, common_1.Module)({
        controllers: [cadastro_controller_1.CadastroController],
        providers: [cadastro_service_1.CadastroService, prisma_service_1.PrismaService],
    })
], CadastroModule);
